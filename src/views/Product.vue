		...
		<section class="product">
			<div v-if="product" class="product__wrapper container">
				<div class="product__slider">
					<flickity ref="flickity" v-images-loaded="imgsLoaded" :options="flickityOptions" class="product__slider-wrapper">
							<img class="carousel-cell" :src="product.productSliderImg" alt="">
							<img class="carousel-cell" src="../assets/img/blackshirt-slider.jpg" alt="">
					</flickity>
				</div>
